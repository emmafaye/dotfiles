...
"      “ Plugin Section
"      Plug 'dracula/vim'                               " Dracula — a really good theme for neovim
"      Plug 'ryanoasis/vim-devicons'                    " nerdcommenter — an easy way for commenting out lines
"      Plug 'SirVer/ultisnips'                          " nerdtree — a file explorer for neovim(netrw comes as default for neovim)
"      Plug 'honza/vim-snippets'                        " vim-devicons — devicon support for nerdtree
"      Plug 'scrooloose/nerdtree'                       " ultisnips — snippets engine
"      Plug 'preservim/nerdcommenter'                   " vim-snippets — a collection of snippets
"      Plug 'mhinz/vim-startify'                        " vim-startify — a really handy start page with lots of customizations
"      Plug 'neoclide/coc.nvim', {'branch': 'release'}  " coc — a fast code completion engine
"  call plug#end()
